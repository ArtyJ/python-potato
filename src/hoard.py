...
if __name__ == '__main__': 
    ...
    # planUpgrade("Amanithrax", 100, 0, 10)
    # planUpgrade("Depth of Sin", 100, 0, 10)
    ...
    # planUpgrade("Mirroed Halls", 100, 0, 10)
    planUpgrade("Primal Rift", 74, 40, 8)
    # planUpgrade("Sea of Sorrow", 100, 30, 10)
